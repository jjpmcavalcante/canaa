...
<section class="form-reserva-list container-fluid col-md-5 col-lg-6" style="margin-top: 20%">
        <h1 class="text-center fw-bolder text-uppercase text mb-4 d-flex justify-content-center gap-1"><img src="../src/img/lista.png" width="10%">conversões</h1>
            ...
            <table class="table table-striped-columns table-hover tabela-cadastro">
                <tbody>
                    ...
                    {
                        echo '<tr class="">';
                        echo '<td class="card d-flex flex-column align-items-center mb-3 shadow bg-light">';
                        echo    '<div class="card-body d-flex flex-column" style="width: 100%">';
                        echo        '<p class="card-text text-uppercase lh-sm" style="font-size: 80%;">
                                        ...
                                        <strong>Data da Conversão: </strong>'
                                            .$user_data['dt_conv'].'<br>
                                        <strong>Endereço: </strong>'
                                            .$user_data['endereco'].'<br>
                                        <strong>Bairro: </strong>'
                                            .$user_data['bairro'].'<br>
                                        <strong>telefone: </strong>'
                                            .$user_data['telefone'].'<br>
                                        <strong>Obs.: </strong>'
                                            .$user_data['observacao'].'<br>
                                    </p>';
                        echo    '</div>';
                        echo '</td>';
                        echo '<tr>';
